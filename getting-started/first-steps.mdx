...
For large portfolios, use the **Bulk Upload Wizard** to import accounts, sites, connections, tariffs, and more from CSV files in a single operation. Open it from your avatar menu under **Bulk Imports**. See [Bulk Importing Data](/guides/bulk-importing-data).
