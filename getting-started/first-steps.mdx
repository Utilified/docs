...
For large portfolios, use the **Bulk Import Wizard** (available from the **+** menu on the Accounts page) to import accounts, sites, connections, and agreements from a CSV file in a single operation.
