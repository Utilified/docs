...
description: "Import accounts, sites, connections, tariffs, meter reads, and more into UMS in bulk from CSV files using the Bulk Upload Wizard, then monitor results and exceptions."
